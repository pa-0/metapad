...
#define ERROROUT(_x) MessageBox(hwnd, _x, GetString(STR_METAPAD), MB_OK | MB_ICONEXCLAMATION)
#define MSGOUT(_x) MessageBox(hwnd, _x, GetString(STR_METAPAD), MB_OK | MB_ICONINFORMATION)
